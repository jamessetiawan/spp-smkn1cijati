    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div
                ...
                <h1 class="h2">Tambah Data Peserta Didik Kelas : <?=strtoupper($detail->nama_kelas)??""?></h1>
            </div>
            <!-- content -->
            <form action=<?=base_url("admin/siswa/{$detail->id_kelas}/insert")?> method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="telepon" id="telepon" placeholder="Masukan No Telp">
                </div>
                <div class="form-group">
